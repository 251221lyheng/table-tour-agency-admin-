...
import CarouselComponent from "./auths/CarouselComponent";
        ...
        <div className="w-[85%] m-auto">
          <div className="grid m-auto gap-5">
            <div className="mt-[30px] mb-[30px]">
              {/* Our tours */}
              <h1 className="text-center text-2xl font-bold text-main  mt-[40px] ">
                Our Tours
              </h1>
      ...
      <div className=" bg-green mt-10 py-5">
        <div className=" w-[73%] m-auto py-8 ">
          <h1 className="text-2xl text-main font-bold ">
            Popular Destination in Seim Reap
          </h1>
          <TrendingComponents />
        </div>
      </div>
